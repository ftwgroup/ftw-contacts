...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('contacts_contact', 'website',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field referred_us_to on 'Contact'
        db.create_table('contacts_contact_referred_us_to', (
        ...
        db.create_unique('contacts_contact_referred_us_to', ['from_contact_id', 'to_contact_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('contacts_contact', 'website')

        # Removing M2M table for field referred_us_to on 'Contact'
        db.delete_table('contacts_contact_referred_us_to')
