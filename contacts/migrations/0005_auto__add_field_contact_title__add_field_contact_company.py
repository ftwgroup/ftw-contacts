...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('contacts_contact', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Contact.company'
        db.add_column('contacts_contact', 'company',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('contacts_contact', 'title')

        # Deleting field 'Contact.company'
        db.delete_column('contacts_contact', 'company')
